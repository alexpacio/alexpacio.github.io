...
BLOG_AUTHOR = "Alessandro Bolletta"  # (translatable)
BLOG_TITLE = "Alessandro's View"  # (translatable)
BLOG_SLOGAN = "Sharing my views about computing. Debunking hype. Promoting what's worth."  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://alexpacio.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://alexpacio.github.io/"
BLOG_EMAIL = "alexpacio91 at gmail dot com"
BLOG_DESCRIPTION = "Engineer sharing insights on cloud-native technologies, Kubernetes, networking, and development practices."  # (translatable)
...
THEME_COLOR = '#00ff00'  # Bright green for terminal/hacker aesthetic
...
#
CODE_COLOR_SCHEME = 'monokai'  # Perfect for dark theme and code
...
FAVICONS = (
    ("icon", "/files/favicon.svg", "any"),
    ("icon", "/files/favicon.ico", "16x16"),  # Fallback for older browsers
)
...
GLOBAL_CONTEXT['blog_slogan'] = BLOG_SLOGAN
